        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.categories')}}"> دسته بندی</a>
                    </li>
                    <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.teams')}}"> تیم </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.manigers')}}">  مدیران </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.abouts')}}">  پروفایل کاربری من </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.skills')}}">  پروفایل  مهارت های من </a>
                    </li>
                </ul>
            </div>
        </li>
