                            ...
                            <form method="post" action="{{route('admin.articles.update',$article->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           name="name"
                                           placeholder="نام مطالب  را وارد نمایید" value="{{$article->name}}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                           name="slug"
                                           placeholder="نام مستعار خود را وارد نمایید" value="{{$article->slug}}">
                                    @error('slug')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    name="description"
                                              placeholder="توضیحات  خود را وارد نمایید"> {{$article->description}}</textarea>
                                    @error('description')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="input-group mb-2">
                                           ...
                                           <input type="text" id="image_label" class="form-control" name="image" value="{{$article->image}}"
