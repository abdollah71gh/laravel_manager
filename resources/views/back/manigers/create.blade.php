@extends('back.index')
@section('title')
پنل  مهندسان - استخدام برنامه نویسان
@endsection
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <div class="row page-title-header">
                <div class="col-12">
                    <div class="page-header">
                        <h4 class="page-title">    ایجاد تیم مهندسی وب </h4>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="container mt-3">
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{route('admin.manigers.store')}}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           name="title"
                                           placeholder=" عنوان خود خود را وارد نمایید" value="{{old('title')}}">
                                    @error('title')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('job') is-invalid @enderror"
                                           name="job"
                                           placeholder="  موقعیت و شغل خود  را وارد نمایید" value="{{old('job')}}">
                                    @error('job')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
