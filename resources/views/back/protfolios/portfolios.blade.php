@extends('back.index')
@section('title')
   پنل نمونه کارها - مدیریت  نمونه کارها
@endsection
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <a href="{{route('admin.portfolios.create')}}" class="btn btn-success rounded-pill btn-block">ایجاد دسته بندی</a>
                            ...
                            <table class="table text-center">
                                ...
                                @foreach($portfolios as $portfolio)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.portfolios.edit',$portfolio->id)}}" class="badge badge-primary">ویرایش</a>
                                            <a href="{{route('admin.portfolios.destroy',$portfolio->id)}} "onclick="return confirm('آیا میخواهید ایتم مورد نظر حذف گردد')"
