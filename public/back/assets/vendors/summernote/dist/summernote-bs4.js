...
(function (factory) {
  ...
  var list = (function () {
    ...
    /**
     * returns true if all of the values in the array pass the predicate truth manigers.
     */
  ...
  var TableResultAction = function (startPoint, where, action, domTable) {
    ...
    /**
     * Recover info abouts row and cell and add information to virtual table.
     *
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      modules: {
        ...
        //  - Script error abouts range when Enter key is pressed on hint popover
